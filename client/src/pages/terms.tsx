...
import { Shield, ChevronLeft, CheckCircle, Info, AlertTriangle, UserCheck, ShieldCheck, Lock, Scale, RefreshCw, Globe, Layers } from "lucide-react";
      ...
      <ScrollArea className="h-[calc(100vh-60px)]">
        <div className="max-w-3xl mx-auto p-6 md:p-10">
          ...
          <div className="space-y-8 text-muted-foreground leading-relaxed">
            <section>
              <h2 className="font-cinzel text-lg text-foreground tracking-wider mb-3 flex items-center gap-2"><CheckCircle className="w-4 h-4 text-primary shrink-0" />ACCEPTANCE OF TERMS</h2>
            ...
            <section>
              <h2 className="font-cinzel text-lg text-foreground tracking-wider mb-3 flex items-center gap-2"><Info className="w-4 h-4 text-primary shrink-0" />DESCRIPTION OF SERVICE</h2>
            ...
            <section>
              ...
              <div className="border-2 border-purple-500/50 bg-purple-500/10 p-4">
                <p className="text-sm text-purple-400 mb-3 font-cinzel tracking-wide">PLEASE READ CAREFULLY</p>
                <ul className="space-y-2 text-sm list-none">
                  <li className="flex items-start gap-2"><span className="text-purple-400 mt-1.5 shrink-0">&#9642;</span> Sentinel Dynamic is a supplementary safety tool and should not be relied upon as your sole means of emergency communication</li>
                  <li className="flex items-start gap-2"><span className="text-purple-400 mt-1.5 shrink-0">&#9642;</span> Always call your local emergency number (e.g., 111, 911, 999, 112) when in immediate danger if it is safe to do so</li>
                  <li className="flex items-start gap-2"><span className="text-purple-400 mt-1.5 shrink-0">&#9642;</span> The application requires an active internet connection to send alerts to contacts. The decoy beep feature works offline</li>
                  <li className="flex items-start gap-2"><span className="text-purple-400 mt-1.5 shrink-0">&#9642;</span> GPS accuracy depends on your device and environmental conditions</li>
                  <li className="flex items-start gap-2"><span className="text-purple-400 mt-1.5 shrink-0">&#9642;</span> Voice recognition accuracy may vary based on background noise, distance, and device capabilities</li>
                </ul>
              </div>
            </section>

            <section>
              <h2 className="font-cinzel text-lg text-foreground tracking-wider mb-3 flex items-center gap-2"><UserCheck className="w-4 h-4 text-primary shrink-0" />USER RESPONSIBILITIES</h2>
              <ul className="space-y-2 text-sm list-none">
            ...
            <section>
              <h2 className="font-cinzel text-lg text-foreground tracking-wider mb-3 flex items-center gap-2"><ShieldCheck className="w-4 h-4 text-primary shrink-0" />ACCEPTABLE USE</h2>
            ...
            <section>
              <h2 className="font-cinzel text-lg text-foreground tracking-wider mb-3 flex items-center gap-2"><Lock className="w-4 h-4 text-primary shrink-0" />INTELLECTUAL PROPERTY</h2>
            ...
            <section>
              <h2 className="font-cinzel text-lg text-foreground tracking-wider mb-3 flex items-center gap-2"><Scale className="w-4 h-4 text-primary shrink-0" />LIMITATION OF LIABILITY</h2>
            ...
            <section>
              <h2 className="font-cinzel text-lg text-foreground tracking-wider mb-3 flex items-center gap-2"><Shield className="w-4 h-4 text-primary shrink-0" />INDEMNIFICATION</h2>
            ...
            <section>
              <h2 className="font-cinzel text-lg text-foreground tracking-wider mb-3 flex items-center gap-2"><RefreshCw className="w-4 h-4 text-primary shrink-0" />MODIFICATIONS TO TERMS</h2>
            ...
            <section>
              <h2 className="font-cinzel text-lg text-foreground tracking-wider mb-3 flex items-center gap-2"><Globe className="w-4 h-4 text-primary shrink-0" />GOVERNING LAW</h2>
            ...
            <section>
              <h2 className="font-cinzel text-lg text-foreground tracking-wider mb-3 flex items-center gap-2"><Layers className="w-4 h-4 text-primary shrink-0" />SEVERABILITY</h2>
