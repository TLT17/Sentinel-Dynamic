...
function VoiceBeepTest() {
  ...
  const borderColor = testState === "detected" ? "border-primary text-primary"
    : testState === "listening" ? "border-purple-400 text-purple-400"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            {!currentPrefs.systemArmed && (
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="mt-8 p-4 border-2 border-purple-500/50 bg-purple-500/10"
              >
                <div className="flex items-start gap-3">
                  <Shield className="w-5 h-5 text-purple-400 mt-0.5" />
                  <div>
                    <p className="text-purple-400 font-cinzel text-sm tracking-wide">SENTINEL OFF</p>
