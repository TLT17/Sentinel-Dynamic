...
function VoiceBeepTest() {
  ...
  const borderColor = testState === "detected" ? "border-primary text-primary"
    : testState === "listening" ? "border-blue-300 text-blue-300"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            {!currentPrefs.systemArmed && (
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="mt-8 p-4 border-2 border-blue-300/50 bg-blue-300/10"
              >
                <div className="flex items-start gap-3">
                  <Shield className="w-5 h-5 text-blue-300 mt-0.5" />
                  <div>
                    <p className="text-blue-300 font-cinzel text-sm tracking-wide">SENTINEL OFF</p>
